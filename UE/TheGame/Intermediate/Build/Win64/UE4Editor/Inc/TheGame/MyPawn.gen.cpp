...
// Cross Module References
	THEGAME_API UClass* Z_Construct_UClass_AMyPawn_NoRegister();
	THEGAME_API UClass* Z_Construct_UClass_AMyPawn();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMyPawn_Statics::NewProp_test_MetaData[] = {
		{ "Category", "VERIEBALSE" },
		{ "ModuleRelativePath", "MyPawn.h" },
	};
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_AMyPawn_Statics::NewProp_test = { "test", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMyPawn, test), METADATA_PARAMS(Z_Construct_UClass_AMyPawn_Statics::NewProp_test_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMyPawn_Statics::NewProp_test_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMyPawn_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMyPawn_Statics::NewProp_test,
	};
	...
	IMPLEMENT_CLASS(AMyPawn, 3768521842);
	template<> THEGAME_API UClass* StaticClass<AMyPawn>()
	{
		return AMyPawn::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyPawn(Z_Construct_UClass_AMyPawn, &AMyPawn::StaticClass, TEXT("/Script/TheGame"), TEXT("AMyPawn"), false, nullptr, nullptr, nullptr);
