...
#include "TheGame/Public/SHGameModeBase.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	THEGAME_API UClass* Z_Construct_UClass_ASHGameModeBase_NoRegister();
	THEGAME_API UClass* Z_Construct_UClass_ASHGameModeBase();
...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASHGameModeBase_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ASHGameModeBase_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_ASHGameModeBase()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_ASHGameModeBase_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(ASHGameModeBase, 2205149471);
	template<> THEGAME_API UClass* StaticClass<ASHGameModeBase>()
	{
		return ASHGameModeBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASHGameModeBase(Z_Construct_UClass_ASHGameModeBase, &ASHGameModeBase::StaticClass, TEXT("/Script/TheGame"), TEXT("ASHGameModeBase"), false, nullptr, nullptr, nullptr);
